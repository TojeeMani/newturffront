...
import TurfLocationInput from '../components/TurfLocationInput';
import ImageUpload from '../components/ImageUpload';
import turfService from '../services/turfService';

const initialTurfState = {
  name: '',
  location: {},
  pricePerHour: '',
  images: [],
...
const OwnerDashboard = () => {
  ...
  const [turf, setTurf] = useState(initialTurfState);
  ...
  const handleLocationChange = (e) => {
    setTurf((prev) => ({ ...prev, location: e.target.value }));
  };

  // Handle image uploads
  const handleImageChange = (files) => {
    setTurf((prev) => ({ ...prev, images: files }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Turf added successfully! It will be reviewed by admin.');
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <button className="btn-primary w-full" onClick={() => setShowAddTurf(true)}>Add Turf</button>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md relative">
              ...
              <div className="flex items-center justify-between px-5 py-3 border-b">
                <h2 className="text-lg font-semibold">Add New Turf</h2>
                <button
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border rounded px-3 py-1.5 text-sm focus:ring focus:border-primary-400"
                        required
                      />
                    </div>
                    <div>
